 ...
 * for example: if the APP_ENV is staging, the bundle id will be com.to-the-moon.staging
 */

// TODO: Replace these values with your own

const BUNDLE_ID = 'com.moon'; // ios bundle id
const PACKAGE = 'com.moon'; // android package name
const NAME = 'moon'; // app name
const EXPO_ACCOUNT_OWNER = 'aleksei.pudnikov'; // expo account owner
const EAS_PROJECT_ID = '1e7a3cd9-bf3d-4213-9892-351d3d1ff471'; // eas project id
const SCHEME = 'moon'; // app scheme
